...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2020 at 01:48 PM
...
CREATE TABLE `aduan` (
  ...
  `punca` text,
  `tarikhpunca` date DEFAULT NULL,
  `pembetulan` text,
  `tarikhtindakan` date DEFAULT NULL,
